				...
				$.ajax({
					...
					success : function (data) {
						if (data.code == "1") {
							...
							htmlStr += "	<img title=\"${sessionScope.sessionUser.name}\" src=\"image/nishikata.jpg\" style=\"width: 30px; height:30px;\">";
							htmlStr += "		<div style=\"position: relative; top: -40px; left: 40px;\" >";
							htmlStr += "			<h5 id=\"h5_" + data.retData.id + "\">" + data.retData.noteContent + "</h5>";
							htmlStr += "			<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small style=\"color: gray;\" id=\"small_" + data.retData.id + "\"> " + data.retData.createTime + " 由${sessionScope.sessionUser.name}创建</small>";
...
<div id="remarkDivList" style="position: relative; top: 30px; left: 40px;">
	...
	<!-- 遍历activityRemarkList,显示所有的备注 -->
	<c:forEach items="${activityRemarkList}" var="activityRemark">
		<div id="div_${activityRemark.id}" class="remarkDiv" style="height: 60px;">
			<img title="${activityRemark.createBy}" src="image/nishikata.jpg" style="width: 30px; height:30px;">
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5 id="h5_${activityRemark.id}">${activityRemark.noteContent}</h5>
				<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;" id="small_${activityRemark.id}"> ${activityRemark.editFlag == "0" ? activityRemark.createTime : activityRemark.editTime} 由${activityRemark.editFlag == "0" ? activityRemark.createBy : activityRemark.editBy}${activityRemark.editFlag == "0" ? "创建" : "修改"}</small>
	...
	<div class="remarkDiv" style="height: 60px;">
		...
		<div style="position: relative; top: -40px; left: 40px;" >
			...
			<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"> ${activityRemark.createTime} 由${activityRemark.editFlag == 0 ? activityRemark.createBy : activityRemark.editBy}${activityRemark.editFlag == 0 ? "创建" : "修改"}</small>
			<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
