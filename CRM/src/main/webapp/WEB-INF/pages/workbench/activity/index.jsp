    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#importActivityBtn").click(function(){
                ...
                //FormData是ajax提供的接口,可以模拟键值向后台提交参数;
                //FormData不仅能提交文本数据,也可以提交二进制数据
                ...
                $.ajax({
                    ...
                    data : formData,
                    processData : false,    //设置ajax向后台提交参数之前,是否将参数统一转换为字符串    默认值为true
                    contentType : false,    //设置ajax向后台提交参数之前,是否把所有的参数统一按urlencode编码    默认值为true
                    type : "post",
                    dataType : "json",
                    success : function (data) {
                        if (data.code == "1") {
                ...
                success:function (data) {
                    ...
                    $("#pageDiv").bs_pagination({
                        ...
                        onChangePage : function (event,pageObj) {
                            /*alert("pageObj.currentPage ==== " + pageObj.currentPage);
                            alert("pageObj.rowsPerPage ==== " + pageObj.rowsPerPage);*/
                            //当切换页号时,重新查询市场活动
            ...
            <div class="modal-body">
                ...
                <form id="createActivityForm" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control date" name="mydate" id="create-startDate" readonly>
                        </div>
                        <label for="create-endDate" class="col-sm-2 control-label">结束日期</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control date" name="mydate" id="create-endDate" readonly>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control date" id="edit-startDate" value="2020-10-10" readonly>
                        </div>
                        <label for="edit-endDate" class="col-sm-2 control-label">结束日期</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control date" id="edit-endDate" value="2020-10-20" readonly>
                        </div>
                    </div>
...
<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar" style="height: 80px;">
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;" id="queryActivityForm">
